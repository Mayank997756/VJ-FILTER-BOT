...
URL = "https://demobotn.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demobotn.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demobotn.onrender.com/".format(FQDN)
else:
    URL = "https://demobotn.onrender.com/".format(FQDN)
