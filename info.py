...
URL = "https://demel.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demel.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demel.onrender.com/".format(FQDN)
else:
    URL = "https://demel.onrender.com/".format(FQDN)
