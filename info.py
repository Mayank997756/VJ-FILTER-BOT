...
URL = "https://demobotzz.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demobotzz.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demobotzz.onrender.com/".format(FQDN)
else:
    URL = "https://demobotzz.onrender.com/".format(FQDN)
