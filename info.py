...
URL = "https://demobott.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demobott.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demobott.onrender.com/".format(FQDN)
else:
    URL = "https://demobott.onrender.com/".format(FQDN)
