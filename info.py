...
URL = "https://demoboti.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demoboti.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demoboti.onrender.com/".format(FQDN)
else:
    URL = "https://demoboti.onrender.com/".format(FQDN)
