...
BOT_TOKEN = environ.get('BOT_TOKEN', "6365222536:AAEwYCK2jNZsAUmb6IoMR0ZDgxx-YYP04j8")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001950409226'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'vj_bot_disscussion')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
AUTO_FFILTER = is_enabled((environ.get('AUTO_FFILTER', "True")), True)
AUTO_DELETE = is_enabled((environ.get('AUTO_DELETE', "True")), True)
SINGLE_BUTTON = is_enabled((nviron.get('SINGLE_BUTTON', "False")), False)
...
URL = "https://demobotlprj.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demobotlprj.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://new-bot-vyob.onrender.com/".format(FQDN)
else:
    URL = "https://new-bot-vyob.onrender.com/".format(FQDN)
