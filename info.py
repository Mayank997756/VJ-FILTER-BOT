...
URL = "https://demobotss.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demobotss.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demobotss.onrender.com/".format(FQDN)
else:
    URL = "https://demobotss.onrender.com/".format(FQDN)
