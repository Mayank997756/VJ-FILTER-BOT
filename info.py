...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6671464166').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://thorkumar56789:pIAAFAr7CW8RKK9f@cluster0.9wfkl4u.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002020322895'))
...
URL = "https://demobotp.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demobotp.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demobotp.onrender.com/".format(FQDN)
else:
    URL = "https://demobotp.onrender.com/".format(FQDN)
