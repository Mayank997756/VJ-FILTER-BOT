...
URL = "https://demobottt.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demobottt.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demobottt.onrender.com/".format(FQDN)
else:
    URL = "https://demobottt.onrender.com/".format(FQDN)
