...
URL = "https://demobotl.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demobotl.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demobotl.onrender.com/".format(FQDN)
else:
    URL = "https://demobotl.onrender.com/".format(FQDN)
