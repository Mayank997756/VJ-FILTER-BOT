qatl# Don't Remove Credit @VJ_Botz
...
BOT_TOKEN = environ.get('BOT_TOKEN', "6899089264:AAEkxXDkb8fB3aiPDqOsQFGL0PbH1f0I1co")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002115135967'))
